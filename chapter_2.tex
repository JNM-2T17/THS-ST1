...
\citeA{Zhang:2012} presents a possible framework for detecting the communities. The k-means clustering algorithm will be one of the proposed algorithms for use in the proposed research.
